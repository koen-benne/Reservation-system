...
use ReservationSystem\Handlers\BaseHandler;
use ReservationSystem\Utils\Session;
use ReservationSystem\Utils\Logger;
/**
 * Class WebBootstrap
...
class WebBootstrap implements BootstrapInterface
{
    ...
    public function setup(): void
    {
        ...
        if (isset($routes[$route])) {
            ...
            $this->className = '\\ReservationSystem\\Handlers\\' . $class;
            $this->action = $action;
        } else {
            header('HTTP/1.0 404 Not Found');
            $this->className = '\\ReservationSystem\\Handlers\\NotFoundHandler';
            $this->action = 'index';
        }
    }
    /**
